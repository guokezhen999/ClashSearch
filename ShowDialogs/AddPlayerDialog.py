...
class AddPlayerDialog(Ui_AddPlayerDialog, QDialog):
    def __init__(self, playerType: PlayerType, database: ClashDatabase):
        super().__init__()
        self.playerType = playerType
        self.database = database

    def showDialog(self):
        self.setWindowTitle("增加玩家")
        ...
        self.pushButton.clicked.connect(self.addPlayer)
    ...
    def addPlayer(self):
        ...
        try:
            self.database.addPlayer(playerDict, self.playerType)
        except Exception as e:
            self.labelResult.setText("标签重复！")
        self.labelResult.setText("添加成功！")
